...
export default function AdminDashboardPostDeleteView({
	toggleModalDelete,
	announcementId,
	deleteAnnouncement,
}: any) {
	...
	const handleSubmit = async (e: React.ChangeEvent<HTMLFormElement>) => {
		...
		try {
			...
			deleteAnnouncement(response.data);

			if (response.status === 200) {
				// If the deletion is successful, update the state to remove the announcement
