...
export default function AdminQuestionUpdateView({
	toggleModalUpdate,
	updateQuestion,
	questionId,
}: any) {
	...
	const [formData, setFormData] = useState<UpdateQuestionFormState>({
		questionText: "",
	});
	...
	const handleSubmit = async (e: React.ChangeEvent<HTMLFormElement>) => {
		...
		try {
			...
			navigate("/admin/questions", {
				state: { message: "Question has been updated successfully!" },
			});
		} catch (error: any) {
			const errorMsg =
